...
const Hero = ({ isDark }) => {
  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex fixed left-8 top-1/2 -translate-y-1/2 flex-col gap-6 z-30">
        <a
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`w-full sm:w-auto px-6 sm:px-8 py-3 rounded-full border transition-all flex items-center justify-center gap-2 ${
              isDark
