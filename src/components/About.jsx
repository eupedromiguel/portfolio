    ...
    <section id="sobre" className="min-h-screen py-12 md:py-20 px-4 md:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          {/* Imagem */}
          <div
            className={`rounded-2xl overflow-hidden ${isDark ? 'bg-white/5 border border-white/10' : 'bg-black/5 border border-black/10'
              }`}
          >
            <img
              src={fotoPedro}
            ...
            <div className="pt-4 md:pt-6">
              ...
              <div className="flex flex-wrap gap-2 md:gap-3">
                ...
                <a
                  ...
                  className={`px-3 md:px-4 py-2 md:py-3 rounded-full border transition-all flex items-center gap-2 text-sm md:text-base ${isDark
